...
- `artifact/errors/diagnostic-*.diagnostic`: lexer EOF edges, parser malformed
  declaration/expression spans, module missing/ambiguous/cyclic validation,
  imported-file source identity, unknown-name, duplicate-name,
