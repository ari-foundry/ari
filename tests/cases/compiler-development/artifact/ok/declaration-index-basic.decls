DeclarationIndex source=tests/cases/compiler-development/artifact/ok/declaration-index-basic.ari modules=1 declarations=7 resolver_surface=imports,uses,declarations order=module-kind-name-location-text
