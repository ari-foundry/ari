...
| `make check-compiler-artifacts` | Deterministic capability inventory, source-map, token, syntax, diagnostic, module graph, declaration index, typed IR, ownership/drop, pass-summary, LLVM-fragment, object/shared-symbol, and runtime-output artifacts. |
