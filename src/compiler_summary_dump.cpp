...
static const CapabilityRow kCapabilityRows[] = {
    ...
    {"union-by-fields", "partial", "parser/type/ownership/backend", "targeted parser diagnostic fixture",
     "reserved discriminant-linked union fields whose active payload type follows a stable field or context path"},
