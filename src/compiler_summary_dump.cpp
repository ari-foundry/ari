...
static const CapabilityRow kCapabilityRows[] = {
    ...
    {"union-by-fields", "partial", "parser/type/ownership/backend", "make check-structs",
     "discriminant-linked union fields with stable selector validation, enum-selector construction via field: arm => payload, direct and nested selector inference, same-literal selector checks, direct field match reading, and selector mutation rejection"},
