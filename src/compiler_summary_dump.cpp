...
static const CapabilityRow kCapabilityRows[] = {
    ...
    {"structural-capability-parameters", "planned", "parser/type/trait-diagnostics", "future trait and diagnostic fixtures",
     "parameter-local has-method capability syntax, structural method requirements, and trait-quality diagnostics without an interface keyword"},
    {"union-by-fields", "planned", "parser/type/ownership/backend", "future aggregate, match, ownership, and layout fixtures",
     "discriminant-linked union fields whose active payload type follows a stable field or context path"},
