...
static const CompilerPassRow kPassRows[] = {
    ...
    {"resolver-index", "frontend", "declaration-collector", "module ASTs",
     "resolver-facing imports, declarations, signatures, and visibility", "--emit-declaration-index",
     "make check-compiler-artifacts",
     "separate source/module shape from typed facts before sema grows further"},
...
std::string dump_compiler_stage_plan(const std::string& source_name,
    ...
    static const StagePlanRow rows[] = {
        ...
        {"ResolverIndex", "declaration-collector", "--emit-declaration-index", "make check-compiler-artifacts",
         "resolver-facing imports, declarations, signatures, visibility, and source locations"},
