...
static const CapabilityRow kCapabilityRows[] = {
    ...
    {"structural-capability-parameters", "partial", "parser/type/trait-diagnostics", "targeted parser diagnostic fixture",
     "parameter-local, generic-bound, and non-generic alias-bound single/grouped has-method capability syntax for free functions and inherent impl methods, static call-site method checks, and trait-quality diagnostics without an interface keyword"},
