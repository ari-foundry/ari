...
const std::unordered_map<std::string, AriBuiltinSignatureExpectation>& ari_builtin_signature_map() {
    static const std::unordered_map<std::string, AriBuiltinSignatureExpectation> signatures = [] {
        ...
        add("ari_builtin_thread_spawn_configured_bytes", builtin_sig({thread_entry, ptr_u8, i64, i64}, thread_handle));
        ...
        add("ari_builtin_thread_spawn_raw_configured_bytes", builtin_sig({thread_raw_entry, ptr_u8, ptr_u8, i64, i64}, thread_handle));
        ...
        add("ari_builtin_net_linger_enabled", builtin_sig({i64}, i64));
        add("ari_builtin_net_linger_seconds", builtin_sig({i64}, i64));
        add("ari_builtin_net_set_linger", builtin_sig({i64, boolean, i64}, boolean));
        ...
        add("ari_builtin_net_unix_listen_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_net_unix_connect", builtin_sig({source_string}, i64));
        add("ari_builtin_net_unix_connect_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_net_unix_datagram_unbound", builtin_sig({}, i64));
        add("ari_builtin_net_unix_datagram_bind", builtin_sig({source_string}, i64));
        add("ari_builtin_net_unix_datagram_bind_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_net_unix_datagram_connect", builtin_sig({i64, source_string}, boolean));
        add("ari_builtin_net_unix_datagram_connect_bytes", builtin_sig({i64, ptr_u8, i64}, boolean));
        add("ari_builtin_net_unix_datagram_send_to", builtin_sig({i64, ptr_u8, i64, source_string}, i64));
        add("ari_builtin_net_unix_datagram_send_to_bytes", builtin_sig({i64, ptr_u8, i64, ptr_u8, i64}, i64));
        ...
        add("ari_builtin_net_lookup_v4_bytes", builtin_sig({ptr_u8, i64, i64}, i64));
        add("ari_builtin_net_lookup_v4_endpoint", builtin_sig({source_string}, i64));
        add("ari_builtin_net_lookup_v4_endpoint_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_net_lookup_v6", builtin_sig({source_string, i64, ptr_u16}, i64));
        add("ari_builtin_net_lookup_v6_bytes", builtin_sig({ptr_u8, i64, i64, ptr_u16}, i64));
        add("ari_builtin_net_lookup_v6_endpoint", builtin_sig({source_string, ptr_u16}, i64));
        add("ari_builtin_net_lookup_v6_endpoint_bytes", builtin_sig({ptr_u8, i64, ptr_u16}, i64));
        add("ari_builtin_fs_exists", builtin_sig({source_string}, boolean));
        add("ari_builtin_fs_exists_bytes", builtin_sig({ptr_u8, i64}, boolean));
        ...
        add("ari_builtin_fs_rename_bytes", builtin_sig({ptr_u8, i64, ptr_u8, i64}, boolean));
        add("ari_builtin_fs_hard_link", builtin_sig({source_string, source_string}, boolean));
        add("ari_builtin_fs_hard_link_bytes", builtin_sig({ptr_u8, i64, ptr_u8, i64}, boolean));
        add("ari_builtin_fs_symbolic_link", builtin_sig({source_string, source_string}, boolean));
        add("ari_builtin_fs_symbolic_link_bytes", builtin_sig({ptr_u8, i64, ptr_u8, i64}, boolean));
        add("ari_builtin_fs_read_link", builtin_sig({source_string}, source_string));
        add("ari_builtin_fs_read_link_bytes", builtin_sig({ptr_u8, i64}, source_string));
        add("ari_builtin_fs_create_dir", builtin_sig({source_string}, boolean));
        add("ari_builtin_fs_create_dir_bytes", builtin_sig({ptr_u8, i64}, boolean));
        add("ari_builtin_fs_create_dir_all", builtin_sig({source_string}, boolean));
        add("ari_builtin_fs_create_dir_all_bytes", builtin_sig({ptr_u8, i64}, boolean));
        ...
        add("ari_builtin_fs_open_options_bytes", builtin_sig({ptr_u8, i64, boolean, boolean, boolean, boolean, boolean, boolean}, fs_file));
        ...
        add("ari_builtin_fs_metadata_uid", builtin_sig({source_string}, i64));
        add("ari_builtin_fs_metadata_gid", builtin_sig({source_string}, i64));
        ...
        add("ari_builtin_fs_symlink_metadata_uid", builtin_sig({source_string}, i64));
        add("ari_builtin_fs_symlink_metadata_gid", builtin_sig({source_string}, i64));
        ...
        add("ari_builtin_fs_metadata_mode_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_fs_metadata_uid_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_fs_metadata_gid_bytes", builtin_sig({ptr_u8, i64}, i64));
        ...
        add("ari_builtin_fs_symlink_metadata_uid_bytes", builtin_sig({ptr_u8, i64}, i64));
        add("ari_builtin_fs_symlink_metadata_gid_bytes", builtin_sig({ptr_u8, i64}, i64));
        ...
        add("ari_builtin_fs_set_mode_bytes", builtin_sig({ptr_u8, i64, i64}, boolean));
        add("ari_builtin_fs_canonicalize", builtin_sig({source_string}, source_string));
        add("ari_builtin_fs_canonicalize_bytes", builtin_sig({ptr_u8, i64}, source_string));
