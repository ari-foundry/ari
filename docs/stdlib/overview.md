...
| `std::fmt` | Formatting traits plus explicit-zone, writer, and stdout formatting helpers. Root `Display`/`Debug` re-export these traits. | `Display::format_in`, `Debug`, `FormatSpec`, `decimal`, `hex`, `binary`, `octal`, `with_width`, `with_precision`, `left`, `right`, `center`, `uppercase`, `alternate`, `unsigned_in`, `integer_in`, `boolean_in`, `float_in`, `text_in`, `debug_text_in`, `write_unsigned`, `write_integer`, `write_boolean`, `write_text`, `write_value`, `print_value`, `println_value`. |
