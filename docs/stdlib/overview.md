...
iterators for keys, values, and set values. Map types expose `contains_key`
as the preferred key-membership spelling while keeping `contains` compatible.
