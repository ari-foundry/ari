...
| `std::vec` | Zone-backed growable sequence. | `Vec[T]`, `new<T>`, owning-zone `push`, `insert`, `reserve`, `reserve_extra`, `extend_from_slice`, `resize`, explicit `_in` compatibility methods, `try_get`, `try_remove`, `retain`, `dedup`, `dedup_by`, `dedup_by_key`, `fill`, `copy_from`, `partition`, `stable_partition`, `slice`, `split_at`, `find`, `contains_slice`, `compare`, `chunks`, `windows`, `split`, `reverse`, `rotate_left`, `rotate_right`, `sort`, `stable_sort`, `is_sorted`, `binary_search`, `lower_bound`, `upper_bound`, `equal_range`, `partition_point`, `min`, `max`, `as_slice`, `iter`. |
...
copying/filling, stable/unstable partitioning, dedup variants, sorting,
