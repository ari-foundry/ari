...
| `std::encoding` | Text validation, UTF-8 scalar helpers, and byte codecs. | `is_ascii`, `is_unicode_scalar`, Result-returning `validate_utf8`, `utf8_count`, `utf16_count`, `encode_utf8_in`, `hex_decoded_len`, `decode_hex_in`, `base64_decoded_len`, `decode_base64_in`, `_optional` compatibility helpers, `_unchecked` asserting codec helpers, `is_utf8`, `is_utf16`, `utf8_at`, `utf8_next_index`, `encode_hex_in`, and `encode_base64_in`. |
