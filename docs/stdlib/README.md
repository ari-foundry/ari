...
`Command`/`Child`/`Output` builder for argument passing, child environment
setup, working-directory setup, `spawn`, `status`, `output_in`, `exec`, `kill`,
and small stdout/stderr capture,
