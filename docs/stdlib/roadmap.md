...
- Grow `std::process` from current-process helpers, POSIX fork/wait,
  ...
  should add readiness-based large output draining, pipe-backed streaming
  stdin, parent-visible setup errors, richer platform status fields, and
  Windows mapping.
