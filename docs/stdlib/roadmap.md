...
growable collection mutation calls, direct iterator support, natural
`contains_key`, `contains_value`, and `get_or` map helpers, target-zone
collection copy, open-addressed `HashMap`/`HashSet` with
