...
- Grow `std::process` from current-process helpers, POSIX fork/wait,
  ...
  reporting, common socket options, and direct `Error` result helpers; next
  ...
  TTL/hop-limit, multicast controls, and Unix datagram/credential helpers. TLS
