...
- Grow `std::process` from current-process helpers, POSIX fork/wait,
  ...
  reporting, common socket options, IPv4 TTL, IPv6 hop-limit, and direct `Error` result helpers; next
  ...
  multicast controls, and Unix peer-credential helpers. TLS
