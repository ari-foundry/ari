...
- Grow `std::process` from current-process helpers, POSIX fork/wait,
  ...
  stdin handles, parent-visible setup errors, richer platform status fields, and
  Windows mapping.
