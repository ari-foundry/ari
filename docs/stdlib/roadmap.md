...
tree-set relationship predicates, map entry iteration, ordered boundary access, and sorted iterators, growable `Deque`, fixed `RingBuffer`, zone-backed
