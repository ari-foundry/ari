...
| `target`, `c`, `os`, future socket handles in `net` | seed | Grow duplicate-with-flags/error policy and broader descriptor flag tests before readiness, signal, mmap, or socket handles. |
