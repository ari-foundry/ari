...
| API | Coverage note |
| --- | --- |
| `fn std::c::close` | check-prelude std-c-interop dynamic library close wrapper; docs/stdlib/modules/c.md |
| `fn std::c::close_result` | check-prelude std-c-interop Result-returning dynamic library close wrapper; docs/stdlib/modules/c.md |
...
| `fn std::c::from_cstr_in` | check-prelude std-c-interop owned CString copy from borrowed CStr; docs/stdlib/modules/c.md |
| `fn std::c::from_cstr_result_in` | check-prelude std-c-interop Result-returning CString copy from borrowed CStr; docs/stdlib/modules/c.md |
| `fn std::c::from_ptr` | check-prelude std-c-interop borrowed non-null raw C string wrapper; docs/stdlib/modules/c.md |
| `fn std::c::from_ptr_result` | check-prelude std-c-interop null-checked Result C string wrapper; docs/stdlib/modules/c.md |
| `fn std::c::from_slice_in` | check-prelude std-c-interop zone-backed NUL-terminated CString constructor; docs/stdlib/modules/c.md |
| `fn std::c::from_slice_result_in` | check-prelude std-c-interop Result-returning CString constructor rejecting interior NUL bytes; docs/stdlib/modules/c.md |
...
| `fn std::c::main_program` | check-prelude std-c-interop current process dynamic symbol handle; docs/stdlib/modules/c.md |
| `fn std::c::main_program_result` | check-prelude std-c-interop Result-returning current process dynamic symbol handle; docs/stdlib/modules/c.md |
| `fn std::c::now` | check-prelude std-c-interop dynamic loader flag helper; docs/stdlib/modules/c.md |
| `fn std::c::open` | check-prelude std-c-interop dynamic library open wrapper; docs/stdlib/modules/c.md |
| `fn std::c::open_result` | check-prelude std-c-interop Result-returning dynamic library open wrapper; docs/stdlib/modules/c.md |
| `fn std::c::symbol` | check-prelude std-c-interop dynamic symbol lookup wrapper; docs/stdlib/modules/c.md |
| `fn std::c::symbol_result` | check-prelude std-c-interop Result-returning dynamic symbol lookup wrapper; docs/stdlib/modules/c.md |
...
| `method std::c::Library::close` | check-prelude std-c-interop dynamic library close method; docs/stdlib/modules/c.md |
| `method std::c::Library::close_result` | check-prelude std-c-interop Result-returning dynamic library close method; docs/stdlib/modules/c.md |
...
| `method std::c::Library::symbol` | check-prelude std-c-interop dynamic symbol lookup method; docs/stdlib/modules/c.md |
| `method std::c::Library::symbol_result` | check-prelude std-c-interop Result-returning dynamic symbol lookup method; docs/stdlib/modules/c.md |
...
| API | Coverage note |
| --- | --- |
| `fn std::encoding::base64_decoded_len` | check-prelude std-encoding-codec standard base64 decoded length validator; docs/stdlib/modules/encoding.md |
| `fn std::encoding::base64_decoded_len_result` | check-prelude std-encoding-codec Result-returning standard base64 decoded length validator; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_base64_in` | check-prelude std-encoding-codec standard base64 zone-backed decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_base64_result_in` | check-prelude std-encoding-codec Result-returning standard base64 zone-backed decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_hex_in` | check-prelude std-encoding-codec hexadecimal zone-backed decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_hex_result_in` | check-prelude std-encoding-codec Result-returning hexadecimal zone-backed decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::encode_utf8_in` | check-prelude std-encoding-utf8-codepoints UTF-8 scalar encoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::encode_utf8_result_in` | check-prelude std-encoding-utf8-codepoints Result-returning UTF-8 scalar encoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::hex_decoded_len` | check-prelude std-encoding-codec hexadecimal decoded length validator; docs/stdlib/modules/encoding.md |
| `fn std::encoding::hex_decoded_len_result` | check-prelude std-encoding-codec Result-returning hexadecimal decoded length validator; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::try_decode_base64_in` | check-prelude std-encoding-codec fallible standard base64 zone-backed decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::try_decode_hex_in` | check-prelude std-encoding-codec fallible hexadecimal zone-backed decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::try_encode_utf8_in` | check-prelude std-encoding-utf8-codepoints fallible UTF-8 scalar encoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::utf16_count` | check-prelude std-encoding-text UTF-16 code-point count validator; docs/stdlib/modules/encoding.md |
| `fn std::encoding::utf16_count_result` | check-prelude std-encoding-text Result-returning UTF-16 code-point count validator; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::utf8_count` | check-prelude std-encoding-text UTF-8 code-point count validator; docs/stdlib/modules/encoding.md |
| `fn std::encoding::utf8_count_result` | check-prelude std-encoding-text Result-returning UTF-8 code-point count validator; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::validate_utf8` | check-prelude std-encoding-text alias for detailed UTF-8 validation; docs/stdlib/modules/encoding.md |
| `fn std::encoding::validate_utf8_result` | check-prelude std-encoding-text Result-returning UTF-8 validation helper; docs/stdlib/modules/encoding.md |
...
| `fn std::env::get` | check-prelude std-env-vars environment variable lookup; docs/stdlib/modules/env.md |
| `fn std::env::get_os` | check-prelude std-env-os-path-views OS-string environment variable lookup; docs/stdlib/modules/env.md |
| `fn std::env::get_os_result` | check-prelude std-env-vars Result-returning OS-string environment variable helper; docs/stdlib/modules/env.md |
| `fn std::env::get_result` | check-prelude std-env-vars Result-returning environment variable helper; docs/stdlib/modules/env.md |
...
| `fn std::env::remove` | check-prelude std-env-vars environment variable removal; docs/stdlib/modules/env.md |
| `fn std::env::remove_result` | check-prelude std-env-vars Result-returning environment variable removal helper; docs/stdlib/modules/env.md |
| `fn std::env::set` | check-prelude std-env-vars environment variable mutation; docs/stdlib/modules/env.md |
...
| `fn std::env::set_result` | check-prelude std-env-vars Result-returning environment variable mutation helper; docs/stdlib/modules/env.md |
...
| `fn std::error::from_errno_result[T]` | check-prelude std-error-integration Result[T, errno] to Result[T, Error] bridge; docs/stdlib/modules/error.md |
...
| `fn std::error::from_os_code_result[T]` | check-prelude std-error-integration Result[T, OS code] to Result[T, Error] bridge; docs/stdlib/modules/error.md |
...
| `fn std::error::from_raw_result[T]` | check-prelude std-error-basic Result[T, i64] to Result[T, Error] compatibility bridge; docs/stdlib/modules/error.md |
...
| `fn std::error::to_raw_result[T]` | check-prelude std-error-basic Result[T, Error] to Result[T, i64] compatibility bridge; docs/stdlib/modules/error.md |
...
| `fn std::fs::create` | check-prelude std-fs-create-truncate-copy source create/truncate open helper; docs/stdlib/modules/fs.md |
| `fn std::fs::create_dir` | check-prelude std-fs-rename-dir runtime-backed single-directory creation hook; docs/stdlib/modules/fs.md |
| `fn std::fs::create_dir_all` | check-prelude std-fs-create-dir-all runtime-backed recursive directory creation hook; docs/stdlib/modules/fs.md |
| `fn std::fs::create_dir_raw_result` | check-prelude std-fs-mutation-result raw Result-returning directory creation compatibility helper; docs/stdlib/modules/fs.md |
| `fn std::fs::create_dir_result` | check-prelude std-fs-mutation-result Result-returning directory creation helper with Error payload; docs/stdlib/modules/fs.md |
| `fn std::fs::create_raw_result` | check-prelude std-fs-open-result raw Result-returning create compatibility helper; docs/stdlib/modules/fs.md |
| `fn std::fs::create_result` | check-prelude std-fs-open-result Result-returning create helper with Error payload; docs/stdlib/modules/fs.md |
...
| `fn std::fs::open` | check-prelude std-fs-open-modes mode-string open hook; docs/stdlib/modules/fs.md |
| `fn std::fs::open_append` | check-prelude std-fs-append compatibility append wrapper over mode-string open; docs/stdlib/modules/fs.md |
| `fn std::fs::open_dir` | check-prelude std-fs-read-dir directory open hook; docs/stdlib/modules/fs.md |
| `fn std::fs::open_dir_raw_result` | check-prelude std-fs-query-result raw Result-returning directory open compatibility helper; docs/stdlib/modules/fs.md |
| `fn std::fs::open_dir_result` | check-prelude std-fs-query-result Error-returning directory open helper; docs/stdlib/modules/fs.md |
...
| `fn std::fs::open_raw_result` | check-prelude std-fs-open-result raw Result-returning mode-string open compatibility helper; docs/stdlib/modules/fs.md |
| `fn std::fs::open_read` | check-prelude std-fs-basic compatibility read wrapper over mode-string open; docs/stdlib/modules/fs.md |
| `fn std::fs::open_result` | check-prelude std-fs-open-result Result-returning mode-string open helper with Error payload; docs/stdlib/modules/fs.md |
...
| `fn std::fs::remove_dir_raw_result` | check-prelude std-fs-mutation-result raw Result-returning directory removal compatibility helper; docs/stdlib/modules/fs.md |
| `fn std::fs::remove_dir_result` | check-prelude std-fs-mutation-result Result-returning directory removal helper with Error payload; docs/stdlib/modules/fs.md |
| `fn std::fs::remove_raw_result` | check-prelude std-fs-mutation-result raw Result-returning unlink compatibility helper; docs/stdlib/modules/fs.md |
| `fn std::fs::remove_result` | check-prelude std-fs-mutation-result Result-returning unlink helper with Error payload; docs/stdlib/modules/fs.md |
| `fn std::fs::rename` | check-prelude std-fs-rename-dir runtime-backed file rename hook; docs/stdlib/modules/fs.md |
...
| `method std::fs::OpenOptions::open` | check-prelude std-fs-open-options direct OpenOptions open helper; docs/stdlib/modules/fs.md |
| `method std::fs::OpenOptions::open_raw_result` | check-prelude std-fs-open-result raw Result-returning OpenOptions open compatibility helper; docs/stdlib/modules/fs.md |
| `method std::fs::OpenOptions::open_result` | check-prelude std-fs-open-result Result-returning OpenOptions open helper with Error payload; docs/stdlib/modules/fs.md |
...
| `fn std::io::copy[R: Reader, W: Writer]` | check-prelude std-io-copy generic Reader-to-Writer copy bool wrapper; docs/stdlib/modules/io.md |
| `fn std::io::copy_result[R: Reader, W: Writer]` | check-prelude std-io-result direct Error Reader-to-Writer byte-count result helper; docs/stdlib/modules/io.md |
| `fn std::io::cursor` | std io trait/cursor tests; docs/stdlib/modules/io.md |
| `fn std::io::flush[W: Writer]` | std io trait/cursor tests; docs/stdlib/modules/io.md |
| `fn std::io::flush_result[W: Writer]` | check-prelude std-io-result direct Error writer flush helper; docs/stdlib/modules/io.md |
...
| `fn std::io::read_exact[R: Reader]` | std io trait/cursor tests; docs/stdlib/modules/io.md |
| `fn std::io::read_exact_result[R: Reader]` | check-prelude std-io-result direct Error exact-read helper; docs/stdlib/modules/io.md |
...
| `fn std::io::write_all[W: Writer]` | std io trait/cursor tests; docs/stdlib/modules/io.md |
| `fn std::io::write_all_result[W: Writer]` | check-prelude std-io-result direct Error whole-slice write helper; docs/stdlib/modules/io.md |
...
| `fn std::net::lookup_v4` | check-prelude std-net-dns-lookup Option-returning IPv4 name lookup; docs/stdlib/modules/net.md |
| `fn std::net::lookup_v4_raw_result` | check-prelude std-net-dns-lookup raw Result-returning IPv4 name lookup compatibility helper; docs/stdlib/modules/net.md |
| `fn std::net::lookup_v4_result` | check-prelude std-net-dns-lookup Result-returning IPv4 name lookup with Error payload; docs/stdlib/modules/net.md |
| `fn std::net::resolve` | check-prelude std-net-dns-lookup Option-returning host-port endpoint resolver; docs/stdlib/modules/net.md |
| `fn std::net::resolve_raw_result` | check-prelude std-net-dns-lookup raw Result-returning host-port endpoint resolver; docs/stdlib/modules/net.md |
| `fn std::net::resolve_result` | check-prelude std-net-dns-lookup Error-returning host-port endpoint resolver; docs/stdlib/modules/net.md |
...
| `fn std::net::to_socket_addrs` | check-prelude std-net-dns-lookup module-level ToSocketAddrs-shaped endpoint resolver; docs/stdlib/modules/net.md |
...
| `method std::net::TcpListener::accept` | check-prelude std-net-tcp-loopback Option-returning TCP accept helper; docs/stdlib/modules/net.md |
| `method std::net::TcpListener::accept_raw_result` | check-prelude std-net-tcp-loopback raw Result-returning TCP accept compatibility helper; docs/stdlib/modules/net.md |
| `method std::net::TcpListener::accept_result` | check-prelude std-net-tcp-loopback Result-returning TCP accept helper with Error payload; docs/stdlib/modules/net.md |
| `method std::net::TcpListener::bind` | check-prelude std-net-tcp-loopback Option-returning IPv4 TCP bind helper; docs/stdlib/modules/net.md |
...
| `method std::net::UnixListener::accept_raw_result` | check-prelude std-net-unix-socket raw Result-returning Unix stream accept compatibility helper; docs/stdlib/modules/net.md |
| `method std::net::UnixListener::accept_result` | check-prelude std-net-unix-socket Result-returning Unix stream accept helper with Error payload; docs/stdlib/modules/net.md |
| `method std::net::UnixListener::bind` | check-prelude std-net-unix-socket Option-returning Unix listener bind helper; docs/stdlib/modules/net.md |
...
| API | Coverage note |
| --- | --- |
| `trait std::net::ToSocketAddrs` | check-prelude std-net-dns-lookup host-port endpoint resolver trait seed; docs/stdlib/modules/net.md |

### trait-method

| API | Coverage note |
| --- | --- |
| `trait-method std::net::ToSocketAddrs::to_socket_addrs` | check-prelude std-net-dns-lookup trait-qualified host-port endpoint resolution; docs/stdlib/modules/net.md |
...
| `fn std::os::pipe` | check-prelude std-os-pipe owned OS pipe descriptor pair constructor; docs/stdlib/modules/os.md |
| `fn std::os::pipe_result` | check-prelude std-os-pipe Result-returning owned OS pipe descriptor pair constructor; docs/stdlib/modules/os.md |
...
| `method std::os::OwnedFd::close` | check-prelude std-os-owned-fd explicit owned descriptor close and disarm helper; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::close_on_exec` | check-prelude std-os-owned-fd-flags close-on-exec descriptor flag query; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::close_on_exec_result` | check-prelude std-os-owned-fd direct Error close-on-exec descriptor flag query; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::close_result` | check-prelude std-os-owned-fd direct Error owned descriptor close and disarm helper; docs/stdlib/modules/os.md |
...
| `method std::os::OwnedFd::is_nonblocking` | check-prelude std-os-owned-fd-nonblocking nonblocking descriptor flag query; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::is_nonblocking_result` | check-prelude std-os-owned-fd direct Error nonblocking descriptor flag query; docs/stdlib/modules/os.md |
...
| `method std::os::OwnedFd::set_close_on_exec` | check-prelude std-os-owned-fd-flags close-on-exec descriptor flag setter; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::set_close_on_exec_result` | check-prelude std-os-owned-fd direct Error close-on-exec descriptor flag setter; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::set_nonblocking` | check-prelude std-os-owned-fd-nonblocking nonblocking descriptor flag setter; docs/stdlib/modules/os.md |
| `method std::os::OwnedFd::set_nonblocking_result` | check-prelude std-os-owned-fd direct Error nonblocking descriptor flag setter; docs/stdlib/modules/os.md |
...
| `method std::os::OwnedFd::try_clone_result` | check-prelude std-os-owned-fd direct Error owned descriptor duplication helper; docs/stdlib/modules/os.md |
| `method std::os::Pipe::close` | check-prelude std-os-pipe close both owned pipe ends; docs/stdlib/modules/os.md |
| `method std::os::Pipe::close_read_end` | check-prelude std-os-pipe close owned pipe read end; docs/stdlib/modules/os.md |
| `method std::os::Pipe::close_read_end_result` | check-prelude std-os-pipe Result-returning close of owned pipe read end; docs/stdlib/modules/os.md |
| `method std::os::Pipe::close_result` | check-prelude std-os-pipe Result-returning close of both owned pipe ends; docs/stdlib/modules/os.md |
| `method std::os::Pipe::close_write_end` | check-prelude std-os-pipe close owned pipe write end; docs/stdlib/modules/os.md |
| `method std::os::Pipe::close_write_end_result` | check-prelude std-os-pipe Result-returning close of owned pipe write end; docs/stdlib/modules/os.md |
...
| `fn std::random::entropy` | check-prelude std-random-basic OS entropy hook; docs/stdlib/modules/random.md |
| `fn std::random::entropy_raw_result` | check-prelude std-random-result raw Result OS entropy hook; docs/stdlib/modules/random.md |
| `fn std::random::entropy_result` | check-prelude std-random-result Error-returning OS entropy hook; docs/stdlib/modules/random.md |
| `fn std::random::fill` | check-prelude std-random-basic OS entropy byte fill helper; docs/stdlib/modules/random.md |
| `fn std::random::fill_from` | check-prelude std-random-basic deterministic PRNG byte fill helper; docs/stdlib/modules/random.md |
| `fn std::random::fill_raw_result` | check-prelude std-random-result raw Result OS entropy byte fill helper; docs/stdlib/modules/random.md |
| `fn std::random::fill_result` | check-prelude std-random-result Error-returning OS entropy byte fill helper; docs/stdlib/modules/random.md |
| `fn std::random::float` | check-prelude std-random-basic unit f64 PRNG helper; docs/stdlib/modules/random.md |
| `fn std::random::from_entropy` | check-prelude std-random-basic OS-seeded PRNG constructor; docs/stdlib/modules/random.md |
| `fn std::random::from_entropy_result` | check-prelude std-random-result Error-returning OS-seeded PRNG constructor; docs/stdlib/modules/random.md |
...
| `fn std::random::seed_from_os` | check-prelude std-random-basic OS-seeded PRNG constructor alias; docs/stdlib/modules/random.md |
| `fn std::random::seed_from_os_result` | check-prelude std-random-result Error-returning OS-seeded PRNG constructor alias; docs/stdlib/modules/random.md |
...
| `method std::random::Prng::from_entropy` | check-prelude std-random-basic OS-seeded PRNG associated constructor; docs/stdlib/modules/random.md |
| `method std::random::Prng::from_entropy_result` | check-prelude std-random-result Error-returning OS-seeded PRNG associated constructor; docs/stdlib/modules/random.md |
...
| `method std::random::Prng::seed_from_os` | check-prelude std-random-basic OS-seeded PRNG associated constructor alias; docs/stdlib/modules/random.md |
| `method std::random::Prng::seed_from_os_result` | check-prelude std-random-result Error-returning OS-seeded PRNG associated constructor alias; docs/stdlib/modules/random.md |
