...
| `core` | 991 | stable candidate |
| `hosted` | 1632 | platform-backed |
...
| `method std::collections::BinaryHeap[T]::new` | check-prelude std-collections-heap natural default-order binary heap constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::BinaryHeap[T]::with_less` | check-prelude std-collections-heap explicit comparator binary heap constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::HashMap[K,V]::new` | check-prelude std-collections-map-natural-api natural default-hash hash map constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::HashMap[K,V]::with_hash` | check-prelude std-collections-hash-with-hash explicit custom-hasher constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::HashSet[T]::new` | check-prelude std-collections-map-natural-api natural default-hash hash set constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::PriorityQueue[T]::new` | check-prelude std-collections-heap natural default-order priority queue constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::PriorityQueue[T]::with_less` | check-prelude std-collections-heap explicit comparator priority queue constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::TreeMap[K,V]::new` | check-prelude std-collections-map-natural-api natural default-order tree map constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::TreeMap[K,V]::with_less` | check-prelude std-collections-tree explicit comparator tree map constructor; docs/stdlib/modules/collections.md |
...
| `method std::collections::TreeSet[T]::new` | check-prelude std-collections-map-natural-api natural default-order tree set constructor; docs/stdlib/modules/collections.md |
...
| `fn std::encoding::decode_base64_mime_optional_with_region` | check-prelude std-encoding-codec Region-backed Option-returning MIME base64 compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_base64_mime_unchecked_with_region` | check-prelude std-encoding-codec asserting MIME base64 Region-backed compatibility decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_base64_mime_with_region` | check-prelude std-encoding-codec Result-returning MIME base64 Region-backed decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_base64_optional_with_region` | check-prelude std-encoding-codec Region-backed Option-returning standard base64 compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_base64_unchecked_with_region` | check-prelude std-encoding-codec asserting standard base64 Region-backed compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_base64_url_optional_with_region` | check-prelude std-encoding-codec Region-backed Option-returning URL-safe base64 compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_base64_url_unchecked_with_region` | check-prelude std-encoding-codec asserting URL-safe base64 Region-backed compatibility decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_base64_url_with_region` | check-prelude std-encoding-codec Result-returning URL-safe base64 Region-backed decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_base64_with_region` | check-prelude std-encoding-codec Result-returning standard base64 Region-backed decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_hex_optional_with_region` | check-prelude std-encoding-codec Region-backed Option-returning hexadecimal compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_hex_unchecked_with_region` | check-prelude std-encoding-codec asserting hexadecimal Region-backed compatibility decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_hex_with_region` | check-prelude std-encoding-codec Result-returning hexadecimal Region-backed decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_utf8_optional_with_region` | check-prelude std-encoding-text Region-backed Option-returning UTF-8 byte-string compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::decode_utf8_unchecked_with_region` | check-prelude std-encoding-text asserting UTF-8 byte-string Region-backed compatibility decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::decode_utf8_with_region` | check-prelude std-encoding-text Result-returning UTF-8 byte-string Region-backed decoder with detailed Utf8Error; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::encode_base64_mime_with_region` | check-prelude std-encoding-codec line-wrapped MIME base64 Region-backed encoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::encode_base64_url_unpadded_with_region` | check-prelude std-encoding-codec unpadded URL-safe base64 Region-backed encoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::encode_base64_url_with_region` | check-prelude std-encoding-codec padded URL-safe base64 Region-backed encoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::encode_base64_with_region` | check-prelude std-encoding-codec standard base64 Region-backed encoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::encode_hex_with_region` | check-prelude std-encoding-codec lowercase hexadecimal Region-backed encoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::encode_utf8_optional_with_region` | check-prelude std-encoding-text Region-backed Option-returning UTF-8 scalar compatibility encoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::encode_utf8_unchecked_with_region` | check-prelude std-encoding-text asserting UTF-8 scalar Region-backed compatibility encoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::encode_utf8_with_region` | check-prelude std-encoding-text Result-returning UTF-8 scalar Region-backed encoder with detailed Utf8Error; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::try_decode_base64_mime_with_region` | check-prelude std-encoding-codec Region-backed Option-returning MIME base64 compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::try_decode_base64_url_with_region` | check-prelude std-encoding-codec Region-backed Option-returning URL-safe base64 compatibility decoder; docs/stdlib/modules/encoding.md |
| `fn std::encoding::try_decode_base64_with_region` | check-prelude std-encoding-codec Region-backed Option-returning standard base64 compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::try_decode_hex_with_region` | check-prelude std-encoding-codec Region-backed Option-returning hexadecimal compatibility decoder; docs/stdlib/modules/encoding.md |
...
| `fn std::encoding::try_encode_utf8_with_region` | check-prelude std-encoding-text Region-backed Option-returning UTF-8 scalar compatibility encoder; docs/stdlib/modules/encoding.md |
...
| `method std::encoding::CodecError::message_with_region` | check-prelude std-encoding-codec Region-backed codec diagnostic message; docs/stdlib/modules/encoding.md |
...
| `method std::encoding::CodecError::name_with_region` | check-prelude std-encoding-codec Region-backed codec diagnostic name; docs/stdlib/modules/encoding.md |
...
| `method std::encoding::Utf8Error::message_with_region` | check-prelude std-encoding-text Region-backed UTF-8 diagnostic message; docs/stdlib/modules/encoding.md |
...
| `method std::encoding::Utf8Error::name_with_region` | check-prelude std-encoding-text Region-backed UTF-8 diagnostic name; docs/stdlib/modules/encoding.md |
...
| `fn std::fmt::write_boolean_stream[W: std::io::Writer]` | check-prelude std-fmt-concat-format-value direct bool streaming writer helper; docs/stdlib/modules/fmt.md |
| `fn std::fmt::write_char_stream[W: std::io::Writer]` | check-prelude std-fmt-concat-format-value direct byte-character streaming writer helper; docs/stdlib/modules/fmt.md |
...
| `fn std::fmt::write_format4` | check-prelude std-fmt-concat-format-value Result-returning four-value Writer-backed runtime template formatter; docs/stdlib/modules/fmt.md |
| `fn std::fmt::write_format_stream` | check-prelude std-fmt-concat-format-value streaming-name one-value Writer-backed runtime template formatter; docs/stdlib/modules/fmt.md |
...
| `fn std::fmt::write_text_stream[W: std::io::Writer]` | check-prelude std-fmt-concat-format-value direct string streaming writer helper; docs/stdlib/modules/fmt.md |
...
| `fn std::fmt::write_unsigned_stream[W: std::io::Writer]` | check-prelude std-fmt-concat-format-value direct unsigned integer streaming writer helper; docs/stdlib/modules/fmt.md |
...
| `fn std::io::buf_reader_with_region[R: Reader]` | check-prelude std-io-result Region-backed buffered reader constructor; docs/stdlib/modules/io.md |
...
| `fn std::io::buf_writer_with_region[W: Writer]` | check-prelude std-io-result Region-backed buffered writer constructor; docs/stdlib/modules/io.md |
...
| `fn std::io::eprint_string` | check-prelude std-io-natural-api Result-returning stderr String helper; docs/stdlib/modules/io.md |
...
| `fn std::io::eprintln_string` | check-prelude std-io-natural-api Result-returning stderr String line helper; docs/stdlib/modules/io.md |
...
| `fn std::io::print_string` | check-prelude std-io-natural-api Result-returning stdout String helper; docs/stdlib/modules/io.md |
...
| `fn std::io::println_string` | check-prelude std-io-natural-api Result-returning stdout String line helper; docs/stdlib/modules/io.md |
...
| `fn std::io::read_all_with_region[R: Reader]` | check-prelude std-io-result Region-backed generic Reader whole-stream byte collector; docs/stdlib/modules/io.md |
...
| `fn std::io::read_line_from_with_region[R: Reader]` | check-prelude std-io-result Region-backed generic line reader helper; docs/stdlib/modules/io.md |
| `fn std::io::read_line_owned` | prelude owned read_line tests; docs/dev/test-matrix.md Prelude and Explicit memory zones rows |
| `fn std::io::read_line_with_region` | check-prelude std-io-result Region-backed stdin line helper; docs/stdlib/modules/io.md |
...
| `fn std::io::read_to_string_unchecked_with_region[R: Reader]` | check-prelude std-io-result unchecked Region-backed generic Reader whole-stream String collector; docs/stdlib/modules/io.md |
| `fn std::io::read_to_string_with_region[R: Reader]` | check-prelude std-io-result Region-backed generic Reader whole-stream owned String collector; docs/stdlib/modules/io.md |
...
| `method std::io::BufReader[R]::read_line_with_region` | check-prelude std-io-result Region-backed buffered reader line helper; docs/stdlib/modules/io.md |
...
| `method std::io::BufReader[R]::read_to_string_with_region` | check-prelude std-io-result Region-backed buffered reader whole-stream helper; docs/stdlib/modules/io.md |
| `method std::io::BufReader[R]::with_capacity` | std io zone-backed buffered tests; docs/stdlib/modules/io.md |
| `method std::io::BufReader[R]::with_capacity_with_region` | check-prelude std-io-result Region-backed buffered reader capacity constructor; docs/stdlib/modules/io.md |
...
| `method std::io::BufWriter[W]::with_capacity_with_region` | check-prelude std-io-result Region-backed buffered writer capacity constructor; docs/stdlib/modules/io.md |
...
| `method std::io::Cursor::read_line_with_region` | check-prelude std-io-result Region-backed cursor line helper; docs/stdlib/modules/io.md |
...
| `method std::io::Cursor::read_to_string_with_region` | check-prelude std-io-result Region-backed cursor whole-stream helper; docs/stdlib/modules/io.md |
...
| `method std::io::PipeReader::read_line_with_region` | check-prelude std-io-result Region-backed pipe reader line helper; docs/stdlib/modules/io.md |
...
| `method std::io::PipeReader::read_to_string_with_region` | check-prelude std-io-result Region-backed pipe reader whole-stream helper; docs/stdlib/modules/io.md |
...
| `method std::io::Stdin::read_line_with_region` | check-prelude std-io-result Region-backed stdin line method; docs/stdlib/modules/io.md |
...
| `method std::io::Stdin::read_to_string_with_region` | check-prelude std-io-result Region-backed stdin whole-stream method; docs/stdlib/modules/io.md |
...
| `fn std::region::decode_base64` | check-prelude std-encoding-codec Region facade for standard base64 decoding; docs/stdlib/modules/region.md |
| `fn std::region::decode_base64_mime` | check-prelude std-encoding-codec Region facade for MIME base64 decoding; docs/stdlib/modules/region.md |
| `fn std::region::decode_base64_url` | check-prelude std-encoding-codec Region facade for URL-safe base64 decoding; docs/stdlib/modules/region.md |
| `fn std::region::decode_hex` | check-prelude std-encoding-codec Region facade for hexadecimal decoding; docs/stdlib/modules/region.md |
| `fn std::region::decode_utf8` | check-prelude std-encoding-text Region facade for UTF-8 byte-string decoding; docs/stdlib/modules/region.md |
...
| `fn std::region::encode_base64` | check-prelude std-encoding-codec Region facade for standard base64 encoding; docs/stdlib/modules/region.md |
| `fn std::region::encode_base64_mime` | check-prelude std-encoding-codec Region facade for MIME base64 encoding; docs/stdlib/modules/region.md |
| `fn std::region::encode_base64_url` | check-prelude std-encoding-codec Region facade for padded URL-safe base64 encoding; docs/stdlib/modules/region.md |
| `fn std::region::encode_base64_url_unpadded` | check-prelude std-encoding-codec Region facade for unpadded URL-safe base64 encoding; docs/stdlib/modules/region.md |
| `fn std::region::encode_hex` | check-prelude std-encoding-codec Region facade for hexadecimal encoding; docs/stdlib/modules/region.md |
| `fn std::region::encode_utf8` | check-prelude std-encoding-text Region facade for UTF-8 scalar encoding; docs/stdlib/modules/region.md |
...
| `fn std::region::io_buf_reader[R: std::io::Reader]` | check-prelude std-io-result Region facade for buffered reader construction; docs/stdlib/modules/region.md |
| `fn std::region::io_buf_writer[W: std::io::Writer]` | check-prelude std-io-result Region facade for buffered writer construction; docs/stdlib/modules/region.md |
| `fn std::region::io_read_all[R: std::io::Reader]` | check-prelude std-io-result Region facade for whole-stream byte reads; docs/stdlib/modules/region.md |
| `fn std::region::io_read_line_from[R: std::io::Reader]` | check-prelude std-io-result Region facade for line reads; docs/stdlib/modules/region.md |
| `fn std::region::io_read_to_string[R: std::io::Reader]` | check-prelude std-io-result Region facade for whole-stream String reads; docs/stdlib/modules/region.md |
...
| `method std::region::Region::decode_base64` | check-prelude std-encoding-codec Region method for standard base64 decoding; docs/stdlib/modules/region.md |
| `method std::region::Region::decode_base64_mime` | check-prelude std-encoding-codec Region method for MIME base64 decoding; docs/stdlib/modules/region.md |
| `method std::region::Region::decode_base64_url` | check-prelude std-encoding-codec Region method for URL-safe base64 decoding; docs/stdlib/modules/region.md |
| `method std::region::Region::decode_hex` | check-prelude std-encoding-codec Region method for hexadecimal decoding; docs/stdlib/modules/region.md |
| `method std::region::Region::decode_utf8` | check-prelude std-encoding-text Region method for UTF-8 byte-string decoding; docs/stdlib/modules/region.md |
| `method std::region::Region::encode_base64` | check-prelude std-encoding-codec Region method for standard base64 encoding; docs/stdlib/modules/region.md |
| `method std::region::Region::encode_base64_mime` | check-prelude std-encoding-codec Region method for MIME base64 encoding; docs/stdlib/modules/region.md |
| `method std::region::Region::encode_base64_url` | check-prelude std-encoding-codec Region method for padded URL-safe base64 encoding; docs/stdlib/modules/region.md |
| `method std::region::Region::encode_base64_url_unpadded` | check-prelude std-encoding-codec Region method for unpadded URL-safe base64 encoding; docs/stdlib/modules/region.md |
| `method std::region::Region::encode_hex` | check-prelude std-encoding-codec Region method for hexadecimal encoding; docs/stdlib/modules/region.md |
| `method std::region::Region::encode_utf8` | check-prelude std-encoding-text Region method for UTF-8 scalar encoding; docs/stdlib/modules/region.md |
...
| `method std::region::Region::io_buf_reader[R: std::io::Reader]` | check-prelude std-io-result Region method for buffered reader construction; docs/stdlib/modules/region.md |
| `method std::region::Region::io_buf_writer[W: std::io::Writer]` | check-prelude std-io-result Region method for buffered writer construction; docs/stdlib/modules/region.md |
| `method std::region::Region::io_read_all[R: std::io::Reader]` | check-prelude std-io-result Region method for whole-stream byte reads; docs/stdlib/modules/region.md |
| `method std::region::Region::io_read_line_from[R: std::io::Reader]` | check-prelude std-io-result Region method for line reads; docs/stdlib/modules/region.md |
| `method std::region::Region::io_read_to_string[R: std::io::Reader]` | check-prelude std-io-result Region method for whole-stream String reads; docs/stdlib/modules/region.md |
...
| `method std::string::String::append_debug_raw_in` | compiler-only debug C-string append bridge for format_in! ptr c_char captures; docs/stdlib/modules/string.md |
...
| `method std::string::String::append_raw_in` | compiler-only raw literal append bridge for format_in! primitive string captures; docs/stdlib/modules/string.md |
