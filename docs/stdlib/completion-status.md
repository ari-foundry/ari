...
| `std::process` | Windows mapping, richer platform status fields, process groups/daemon helpers or stronger background-reaping policy, and possible ref-mut fluent command aliases that do not hide allocation. |
