...
policy diagnostic. Future compiler work must define runtime selector
consistency, public active-arm narrowing after discriminant checks, active-arm
drop diagnostics, and stable ABI naming before stdlib code should depend on it.
