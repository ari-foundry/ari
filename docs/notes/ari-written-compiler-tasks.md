...
- Backfill reusable keyword-table smoke coverage for existing `continue`,
  preserving longer identifiers such as `continue1`.

## Next Recommended Task

Backfill reusable keyword-table smoke coverage for existing `continue`, preserving
longer identifiers such as `continue1`.
