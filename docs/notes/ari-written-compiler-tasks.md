...
- Backfill reusable keyword-table smoke coverage for existing `break`,
  preserving longer identifiers such as `break1`.

## Next Recommended Task

Backfill reusable keyword-table smoke coverage for existing `break`, preserving
longer identifiers such as `break1`.
