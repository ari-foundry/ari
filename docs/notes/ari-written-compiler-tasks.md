...
- Backfill reusable keyword-table smoke coverage for existing `else`,
  preserving longer identifiers such as `elsewhere`.

## Next Recommended Task

Backfill reusable keyword-table smoke coverage for existing `else`, preserving
longer identifiers such as `elsewhere`.
