...
| raw IO | `io::Reader`, `io::Writer`, `io::Seek`, `io::BufReader`, `io::BufWriter`, `io::pipe()`, `io::pipe_optional()`, `io::cursor(bytes)`, `io::read_exact`, `io::read_line_from`, `io::read_to_string`, `io::stdout()`, `io::stderr()`, `io::write`, `io::write_all`, `io::flush`, `io::print_text`, `io::eprintln_text`, `io::write_bytes`, `io::newline` |
