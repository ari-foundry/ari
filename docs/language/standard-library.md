...
streams. IPv6 socket handles, buffer datagrams, richer options, and direct
`Result[..., Error]` payloads still need owned OS-resource and error policy.
