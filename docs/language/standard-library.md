...
| `std::encoding` | Text validation, UTF-8 scalar helpers, and byte codecs. | `Utf8Char`, `is_ascii`, `is_unicode_scalar`, `utf8_count`, `is_utf8`, `utf8_width`, `utf8_encoded_len`, `utf8_at`, `utf8_next_index`, `encode_utf8_in`, `utf16_count`, `is_utf16`, `hex_encoded_len`, `encode_hex_in`, `hex_decoded_len`, `can_decode_hex`, `decode_hex_in`, `try_decode_hex_in`, `base64_encoded_len`, `encode_base64_in`, `base64_decoded_len`, `can_decode_base64`, `decode_base64_in`, `try_decode_base64_in`. | Implemented in Ari source. Use `try_decode_*_in` for untrusted input and `decode_*_in` only when invalid input is a programmer error. |
