...
| discriminant-linked `union by` fields | complete for current enum/bool selector subset | [Generic Aggregates](generic-aggregates.md) | `tests/cases/structs/`, `make check-structs` |
