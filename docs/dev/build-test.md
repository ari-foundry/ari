...
fieldless enum declarations, by-value header ABI target/size guards, meta
signatures over `token_stream`/`ast`, and planned Rust-style `name!(...)`
macro invocation diagnostics.
