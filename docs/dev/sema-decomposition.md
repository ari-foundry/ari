...
- `meta_token_eval` for token_stream meta return validation/evaluation,
  including meta-input token substitution and the current empty/count/first-token
  branch evaluator used before expression/item/pattern macro output is reparsed
