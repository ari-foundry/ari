...
forwarding field. Generic method bodies that call `T::serialize` directly
still need their own explicit bound until broader implicit bound import for
method bodies is designed.
