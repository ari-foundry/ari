...
13. Extend positive fixtures after active-arm drop behavior is real. Until
    then, direct field matches, selector-path matches, wrapper selector-path
    matches, and local alias matches are the supported ways to read active
    payloads.
