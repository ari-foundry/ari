...
9. Reject direct selector mutation after construction. This is implemented for
...
10. Define layout and ABI. The payload storage is union-like, but ownership/drop
   must run only for the active arm.
11. Extend positive fixtures after broader narrowing and active-arm drop
