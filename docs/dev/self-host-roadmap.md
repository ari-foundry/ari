...
- **32-37% ready** to begin full compiler bootstrapping
...
values, diagnostic formatting, small parser utilities, and golden-test tools.
...
| Diagnostics | Basic logging, panic, formatting, test helpers, and `std::source` source-coordinate values exist. | Source maps, diagnostic builders, notes, labels, fix-it text, and stable golden output. |
