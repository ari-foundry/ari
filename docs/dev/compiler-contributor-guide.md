...
| Stage-plan, token, source-map, syntax, diagnostic catalog, diagnostic, module-graph, declaration, typed-IR, or pass-summary artifacts | `make check-compiler-artifacts` |
