...
tests/cases/compiler-development/artifact/errors/diagnostic-match-empty.diagnostic
tests/cases/compiler-development/artifact/errors/diagnostic-match-expression-type-mismatch.diagnostic
tests/cases/compiler-development/artifact/errors/diagnostic-match-no-payload.diagnostic
tests/cases/compiler-development/artifact/errors/diagnostic-match-non-enum.diagnostic
tests/cases/compiler-development/artifact/errors/diagnostic-match-nonexhaustive.diagnostic
tests/cases/compiler-development/artifact/errors/diagnostic-match-payload-required.diagnostic
...
tests/cases/compiler-development/artifact/errors/diagnostic-match-wrong-enum-case.diagnostic
