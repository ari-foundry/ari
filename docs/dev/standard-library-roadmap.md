...
- `std::source` source-coordinate values for compiler tools: `FileId`,
  ...
  `SourceFile` text lookup, explicit-zone `LineMap` cached line tables, and
  natural containment, boundary, line, same-file, merge, and ordering helpers
