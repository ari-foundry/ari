...
- the first `std::process` current-process helpers: `id`, `uid`, `gid`, `exit`,
  ...
  `Command`/`Child`/`Output`, `spawn`, `status`, `output_in`, `exec`, `kill`,
  child environment setup, child working-directory setup, and small
