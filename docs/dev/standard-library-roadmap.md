...
- the first `std::process` current-process helpers: `id`, `uid`, `gid`, `exit`,
  ...
  `Command`/`Child`, `spawn`, `status`, `exec`, `kill`, child environment
  setup, and child working-directory setup
