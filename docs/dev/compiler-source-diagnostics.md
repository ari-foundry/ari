...
| Ownership/borrow/drop diagnostics | already SourceId/Span-backed for supported ownership checks | Borrow conflict, use-after-move, live-owner return/break/continue exits, moving borrowed owners, partial moves, and unsupported dynamic or temporary owner-element moves point at the expression, binding, or control-flow keyword span; `diagnostic-borrow-conflict.diagnostic`, `diagnostic-use-after-move.diagnostic`, `diagnostic-return-live-owner.diagnostic`, `diagnostic-loop-break-live-owner.diagnostic`, `diagnostic-loop-continue-live-owner.diagnostic`, `diagnostic-move-borrowed-owner.diagnostic`, `diagnostic-ownership-partial-move.diagnostic`, `diagnostic-ownership-vector-dynamic-move.diagnostic`, and `diagnostic-ownership-temporary-element-move.diagnostic` are the golden fixtures. |
