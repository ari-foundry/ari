...
- [x] lower refutable scalar literal/range, or-pattern, fieldless enum-case,
      compact enum payload, and homogeneous nested aggregate-enum payload item
      patterns for `Iterator[T]` loops with stop-on-first-mismatch semantics
...
- [x] lower iterator item literal/range/or, fieldless enum-case, compact enum
      payload, and homogeneous nested aggregate-enum payload patterns through
