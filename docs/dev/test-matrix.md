...
- [x] lower refutable scalar literal/range, or-pattern, and fieldless enum-case
      item patterns for `Iterator[T]` loops with stop-on-first-mismatch
      semantics
...
- [x] lower iterator item literal/range/or and fieldless enum-case patterns
