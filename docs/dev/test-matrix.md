...
- [x] source `std::collections::Set<T>` exposes a tracked linear
      ...
      `contains`, `index_of`, `insert`, `remove`, `take`, `clear`,
      `as_slice`, and `copy_to`, plus reset/destroy invalidation and
      same-zone insertion diagnostics
