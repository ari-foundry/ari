...
- [x] support freestanding direct and function-pointer call parameters for
      tuple, struct, fixed-array, and aggregate enum values through hidden
      argument pointers copied into callee-local storage
