...
- [x] lower `format_in!(ref mut Zone, "...", values...)` to source
      ...
      append helpers, with value expressions evaluated once before type-directed
      append selection and `{:.N}` float precision matching `print`
